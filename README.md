...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-032-b-project-todo-list.git`
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-032-b-project-todo-list`
  ...
  - Verifique que você está na raiz do projeto
    - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/joaozinho/code/**sd-032-b-project-todo-list**_
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-b-project-todo-list/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-b-project-todo-list/pulls) e confira que o seu _Pull Request_ está criado
...
**Leva menos de 3 minutos!**
  ...
  Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH32-B&template=betrybe/sd-0x-project-todo-list)
